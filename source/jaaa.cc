...
XrmOptionDescRec options [NOPTS] =
{
    ...
    {CP"-F",   CP".maxfreq",   XrmoptionSepArg,  0        },
    {CP"-f",   CP".minfreq",   XrmoptionSepArg,  0        },
    {CP"--a4",   CP".a4",        XrmoptionSepArg,  0        }
};
...
static void help (void)
{
    ...
    fprintf (stderr, "  -f <minfreq>       Min. analysis freq [0]\n");
    fprintf (stderr, "  -F <maxfreq>       Max. analysis freq [samplerate/2]\n");
    fprintf (stderr, "  --a4 <freq>        Freq. of A4 [440 Hz]\n");
